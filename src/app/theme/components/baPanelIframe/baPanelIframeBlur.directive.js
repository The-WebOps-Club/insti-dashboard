...
(function () {
  ...
  angular.module('BlurAdmin.theme')
      .directive('baPanelIframeBlur', baPanelIframeBlur);

  /** @ngInject */
  function baPanelIframeBlur(baPanelIframeBlurHelper, $window, $rootScope) {
    var bodyBgSize;

    baPanelIframeBlurHelper.bodyBgLoad().then(function() {
      bodyBgSize = baPanelIframeBlurHelper.getBodyBgImageSizes();
    });
