/**
 * @file src/app/pages/network/NetworkAdminPageCtrl.js
...
(function () {
  ...
  angular.module('BlurAdmin.pages.networkAdmin')
    .controller('NetworkAdminPageCtrl', NetworkAdminPageCtrl);

  /** @ngInject */
  function NetworkAdminPageCtrl($scope, fileReader, $filter, $uibModal, api, toastr, $timeout) {
    ...
    $scope.showModal = function(modal, params) {
      ...
      } else if (modal == 'processRequest') {
        $uibModal.open({
          animation: true,
          controller: 'ProcessRequestModalCtrl',
          templateUrl: 'app/components/networkModals/processRequestModal.html',
          resolve: {
            params: function() {
              return params;
            }
